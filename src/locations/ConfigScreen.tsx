...
import { Heading, Paragraph, Note, Stack, Box, List, SectionHeading, Text } from '@contentful/f36-components';
  ...
  return (
    <Box padding="spacingXl" style={{ maxWidth: '900px', margin: '0 auto' }}>
      <Stack flexDirection="column" spacing="spacingXl" alignItems="stretch">
        <Stack flexDirection="column" spacing="spacingS" alignItems="flex-start" style={fullWidth}>
        ...
        <Stack flexDirection="column" spacing="spacingL" alignItems="stretch" style={fullWidth}>
          <Box style={fullWidth}>
        ...
        <Note variant="primary" title="Permissions">
          <Stack flexDirection="column" spacing="spacingXs" alignItems="flex-start" style={fullWidth}>
            <Text>
